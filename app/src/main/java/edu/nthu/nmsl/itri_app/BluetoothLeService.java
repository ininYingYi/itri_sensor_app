...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_BLUE_DIAL_SERVICE =
            UUID.fromString("a495ff10-c5b1-4b44-b512-1370f02d74de");
    public final static UUID UUID_BLUEDIAL_DATA =
            UUID.fromString("a495ff11-c5b1-4b44-b512-1370f02d74de");
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            ...
            if(status == BluetoothGatt.GATT_SUCCESS){
                Log.d(TAG,"Success write descriptor");
            }else {
                Log.d(TAG,"Fail to write descriptor");
            }
        }
    };
    ...
    private String dataString = BuildConfig.FLAVOR;
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        Log.w(TAG, "Open local notification service");
        //Open local (APP) Notification listener
        mBluetoothGatt.setCharacteristicNotification(characteristic, enabled);

        // This is specific to Dial. Open Remote notification
        if (UUID_BLUEDIAL_DATA.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"));
            if (descriptor == null){
                Log.d(TAG,"Null Descriptor");
            }else {
                descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
                mBluetoothGatt.writeDescriptor(descriptor);
                Log.w(TAG, "Open remote notification service");
            }
